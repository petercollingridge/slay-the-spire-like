const CARD_DATA = {
  ...
  "Slice 'n' dice": {
    ...
    time: 1,
    power: 3,
    onResolve: [{ damage: 'power' }, { damage: 'power' }],
    target: 'enemy',
    rarity: 2,
  },
  "Smash 'n' bash": {
  ...
  'Arcane sword': {
    ...
    cost: 2,
    power: 2,
    onResolve: { damage: (card) => card.source.hand.cards.length * card.power },
    target: 'enemy',
    rarity: 3,
  },
  'Scythe': {
    ...
    time: 1,
    power: 1,
    onResolve: { damage: (card) => card.source.discard.cards.length * card.power },
    target: 'enemy',
    rarity: 3,
  },
  'Quick shield': {
